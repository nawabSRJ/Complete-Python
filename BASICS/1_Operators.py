...
print('10^5 : ',p**q)     # *Exponentiation Operator

print(100/3)
print(100//3)       # *Floor Division Operator

print('10 MOD 3 : ',10%3)     # * Modulus Operator
...
r = 10
s = 2
print(f'Augmented Multiplication when r is {r} and s is {s} then r*=s is :')
r*=s
print(r) 
...
o = 5
p = 10 - 5
print(f'if r is {r} and s is {s} then r<s is : ',r<s)
print(f'is r is {r} and s is {s} then r>s is : ',r>s)
print(o == p)
print(o != p)
print(o <= p)
print(o >= p)
print(f'Case Test : {o} == {p} is : ','a' == 'A')   # * Test for Case Sensitivity
